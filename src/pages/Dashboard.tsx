...
const Dashboard = () => {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center h-[80vh] bg-gradient-to-br from-blue-50 via-white to-purple-50">
        <motion.div
            ...
            />
              ...
              <div className="flex items-center justify-between">
                ...
                <motion.div
                  ...
                  className="text-right bg-white/10 backdrop-blur-sm px-4 py-3 rounded-xl border border-white/20"
                >
                ...
                <Card className={`border-0 shadow-lg hover:shadow-2xl transition-all duration-300 group cursor-pointer h-full bg-white/80 backdrop-blur-sm ${stat.bgGlow}`}>
                  <CardContent className="p-6">
                    <div className="flex flex-col gap-4">
                      <div className="flex items-center justify-between">
                        <div
                          className={`w-14 h-14 rounded-2xl bg-gradient-to-r ${stat.color} flex items-center justify-center shadow-lg group-hover:scale-110 group-hover:rotate-3 transition-transform duration-300`}
                        >
              ...
              <CardHeader className="pb-4 relative z-10">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <CardDescription className="text-base mt-1">Latest leads, visits & chats</CardDescription>
                  </div>
                    ...
                    activity.map((item, index) => {
                      ...
                      return (
                        <motion.div
                          ...
                          className="flex items-center gap-4 p-4 rounded-2xl hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 transition-all duration-200 border border-transparent hover:border-blue-100 cursor-pointer"
                        >
          ...
          <motion.div variants={itemVariants}>
            <Card className="border-0 shadow-xl bg-white/80 backdrop-blur-sm h-full overflow-hidden relative">
              ...
              <CardHeader className="pb-4 relative z-10">
                ...
                <CardDescription className="text-base mt-1">By conversions & revenue</CardDescription>
              </CardHeader>
              <CardContent className="relative z-10">
                  ...
                  {topAgents.length === 0 ? (
                    ...
                    topAgents.map((agent, index) => (
                      <motion.div
                        ...
                        className="flex items-center gap-4 p-4 rounded-2xl hover:bg-gradient-to-r hover:from-purple-50 hover:to-pink-50 transition-all duration-200 border border-transparent hover:border-purple-100 cursor-pointer"
                      >
                        <div className="relative">
                          <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 flex items-center justify-center text-white font-bold text-lg shadow-lg">
                          ...
                          <motion.span
                            ...
                            className="absolute -top-2 -right-2 text-xs font-bold text-white bg-gradient-to-r from-emerald-500 to-green-500 rounded-full w-7 h-7 flex items-center justify-center shadow-lg"
                          >
                            {index + 1}
                          </motion.span>
                        </div>
          ...
          <motion.div variants={itemVariants}>
            <Card className="border-0 shadow-xl bg-white/80 backdrop-blur-sm overflow-hidden relative">
              ...
              <CardHeader className="relative z-10">
                ...
                <CardDescription className="text-base">Daily new leads vs closed</CardDescription>
              </CardHeader>
              <CardContent className="relative z-10">
          ...
          <motion.div variants={itemVariants}>
            <Card className="border-0 shadow-xl bg-white/80 backdrop-blur-sm overflow-hidden relative">
              ...
              <CardHeader className="relative z-10">
                ...
                <CardDescription className="text-base">How many visits turn into deals</CardDescription>
              </CardHeader>
              <CardContent className="relative z-10">
                <div className="flex flex-col items-center justify-center h-72">
                  ...
                  <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ delay: 1 }}
                    className="mt-6 text-center bg-gradient-to-r from-green-50 to-emerald-50 px-6 py-3 rounded-2xl border border-green-100"
                  >
