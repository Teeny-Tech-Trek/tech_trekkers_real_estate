      ...
      <div className="container px-4 sm:px-6 lg:px-8" ref={containerRef}>
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-12 items-center">
          <div className="w-full lg:w-1/2">
            ...
            >
              Virtual Sales Agents<br className="hidden sm:inline" />That Never Sleep
            </h1>
            ...
            >
              Deploy AI-powered avatars to capture leads, manage properties, and close deals 24/7 while you focus on what matters most.
            </p>
